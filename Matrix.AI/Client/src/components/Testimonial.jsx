      ...
      {[...Array(5)].map((_, i) => (
        ...
        >
          <path
            ...
            fill={i < rating ? "#FF532E" : "#E5E7EB"} // filled or gray
          />
        </svg>
      ))}
    </div>
...
const testimonials = [
  ...
  },
  {
    ...
    feedback:
      "This platform streamlined my workflow and boosted my productivity. Highly recommended for any content creator!",
    rating: 5,
  },
  {
    ...
    feedback:
      "The AI tools are game-changing. Easy to use, reliable, and incredibly effective for scaling projects.",
    rating: 5,
  },
]
...
function Testimonial() {
  return (
    <div className="text-center px-4 sm:px-20 xl:px-32 my-24">
      ...
      <div className="flex flex-wrap justify-center gap-8 mt-16">
        {testimonials.map((t, i) => (
          <div
            key={i}
            className="w-80 flex flex-col items-start border border-gray-200 p-6 rounded-2xl bg-white shadow-md hover:shadow-lg transition-all duration-300"
          >
            {/* Quote icon */}
            <svg
              width="44"
            ...
            {/* Feedback */}
            <p className="text-sm mt-3 text-gray-500">{t.feedback}</p>
