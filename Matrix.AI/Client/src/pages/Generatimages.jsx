...
import { Sparkles, Hash, Image as ImageIcon } from 'lucide-react'  // ✅ Import Image icon properly
    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      >
        ...
        <textarea
          ...
          value={input}
          rows={4}   // ✅ fixed, textarea supports rows
        ...
        <button
               ...
               >
                {
                  Loading ? <span className='w-4 h-4 my-1 rounded-full border-2 border-t-transparent animate-spin'> </span> :   <ImageIcon className='w-5' />
                }               
                 Generate Image
               </button>
      </form>
      ...
      >
        <div className='flex items-center gap-3'>
          <ImageIcon className='w-5 h-5 text-[#00AD25]' /> {/* ✅ consistent color */}
