  ...
  return (
    ...
    >
      ...
      <input
        ...
        accept='image/*'
        type='file'
        className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300 text-gray-300'
...
export default RemoveBackgraound